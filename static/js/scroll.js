(function() {
    ...
    function updateReadingProgress() {
        ...
        topProgressText.textContent = rounded + '%';
    }
    ...
    function updateReadingTime() {
        ...
        const timeElement = document.getElementById('top-progress-time');
        if (!contentView || !timeElement) {
        ...
        let display;
        if (minutes < 1) {
            display = window.i18n.lessThanOne || '<1 min';
        } else if (minutes === 1) {
            display = window.i18n.oneMinute || '1 min';
        } else {
            display = minutes + ' ' + (window.i18n.minutesFormat || 'min');
        }
